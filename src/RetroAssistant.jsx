...
<svg width="60" height="60" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[4px_4px_0px_rgba(0,0,0,1)]">
    ...
    <path d="M4 2H8V10H10V8H12V6H14V4H18V8H16V10H14V12H12V14H14V16H16V18H18V22H14V20H12V18H10V16H8V22H4V2ZM18 6H16V8H18V6Z" fill="#89CFF0" stroke="black" strokeWidth="1"/>
    {/* Oeil gauche */}
...
export default function RetroAssistant({ tasks }) {
  ...
  useEffect(() => {
    const analyzeAndSpeak = () => {
      ...
      const todoCount = tasks.filter(t => !t.completed && (t.columnId === 'today' || t.columnId === 'week')).length;
    ...
    <div className="fixed bottom-8 right-8 hidden md:flex flex-col items-end z-50 pointer-events-none">
      ...
      {isVisible && message && (
        <div className="mb-4 relative bg-[#FFFFE1] border-2 border-black shadow-[4px_4px_0px_0px_black] p-4 max-w-xs animate-bounce-in origin-bottom-right font-mono text-sm pointer-events-auto">
          ...
          <div className="absolute bottom-[-10px] right-6 w-0 h-0 
              border-l-[10px] border-l-transparent
              border-r-[10px] border-r-transparent
              border-t-[10px] border-t-black">
          </div>
           <div className="absolute bottom-[-7px] right-[26px] w-0 h-0 z-10

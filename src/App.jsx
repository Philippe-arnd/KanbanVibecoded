            ...
            <div className="flex justify-between items-center w-full md:w-auto gap-4">
              <div className="bg-black/10 p-1 rounded-sm inline-flex items-center self-start border-2 border-black">
                ...
                <div className="relative" ref={settingsRef}>
                  ...
                  {showSettingsMenu && (
                    <div className="absolute left-0 top-full mt-2 w-56 bg-white border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] z-50 flex flex-col animate-in fade-in zoom-in duration-200">
                      <button 

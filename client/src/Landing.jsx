      ...
      <div className="max-w-6xl mx-auto bg-[#E0EBDD] border-2 border-black shadow-[8px_8px_0px_black]">
        ...
        <div className="border-b-2 border-black bg-[#E0EBDD] p-4 flex justify-between items-center sticky top-0 z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-lg tracking-tight uppercase hidden md:inline">
              Vibecodé Systems Inc.
            </span>
          </div>
          <Link
            to="/app"
            className="bg-[#89CFF0] hover:bg-[#7bc0e0] text-black font-bold py-2 px-6 border-2 border-black shadow-[4px_4px_0px_black] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none transition-none flex items-center gap-2"
          >
            <Monitor size={18} />
            LAUNCH APP
          </Link>
        ...
        <div className="p-8 md:p-20 flex flex-col items-center text-center border-b-2 border-black bg-[url('https://www.transparenttextures.com/patterns/graphy.png')]">
          ...
          <div className="flex flex-col md:flex-row gap-6">
            <Link
              to="/app"
              className="bg-[#88D8B0] text-black text-xl font-bold py-4 px-10 border-2 border-black shadow-[6px_6px_0px_black] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none hover:bg-[#75cba0] transition-none"
            >
              START NOW {'>'}
            </Link>
            <a
              ...
              className="bg-[#E0EBDD] text-black text-xl font-bold py-4 px-10 border-2 border-black shadow-[6px_6px_0px_black] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none hover:bg-white transition-none"
            >
              LEARN MORE
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y-2 md:divide-y-0 md:divide-x-2 divide-black">
          <div className="p-10 hover:bg-[#FFFFE1] transition-colors group">
            ...
            <p className="text-gray-700 leading-relaxed">
              Switch between <strong>PRO</strong> and <strong>PERSONAL</strong> mode as fast as a
              floppy disk. No more mixing groceries and deadlines.
            </p>
          </div>
          ...
          <div className="p-10 hover:bg-[#FFFFE1] transition-colors group">
            ...
            <p className="text-gray-700 leading-relaxed">
              Cutting-edge "Drag and Drop" technology. Tactile sensation guaranteed. Click, hold,
              move. It's magic.
            </p>
          </div>
        ...
        <div className="bg-black text-green-400 p-8 font-mono border-t-2 border-black">
          ...
          <div className="border border-green-700 p-4 bg-gray-900 mb-4">
            "Finally an app that doesn't look like all the others. The Windows 95 style is
            incredible and it really helps me get organized."
            <br />
            <span className="text-white mt-2 block">- Marie, Project Manager</span>
          </div>
